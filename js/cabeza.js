let mapa_cabeza = L.map("mapa-cabeza").setView(
...
info.update = function (props) {
  this._div.innerHTML =
    "<h4> <strong>Su cabeza </strong> <h4>" + "tu<sup>2</sup>ku<sup>2</sup>";
};
info.addTo(mapa_cabeza);
...
document
  ...
  .addEventListener("change", function (e) {
    ...
    mapa_cabeza.flyTo(coords, 14);
  });

// Municipios mazatecos
L.geoJSON(municipios).addTo(mapa_cabeza);

//icono de huevo-azul
var blueIcon = L.icon({
  iconUrl: "icons/cabeza/cabeza-azul.png",
  iconSize: [30, 30],
});

// icono de huevo-rojo
var redIcon = L.icon({
  iconUrl: "icons/cabeza/cabeza-rojo.png",
  iconSize: [30, 30],
});

// icono de huevo-amarillo
var yellowIcon = L.icon({
  iconUrl: "icons/cabeza/cabeza-amarillo.png",
  iconSize: [30, 30],
});
...
var cuau = L.marker([18.207051606631374, -96.91168268606408], {
  ...
  .bindPopup(
    "<strong>ku</strong><p>[kɨ]</p>" +
      '<audio controls><source src="audios/cabeza/OT11-20-14-01-H1-HCG-597_se cabeza.wav"></source></audio>'
  );
var elox = L.marker([18.1773054185917, -96.8767721148899], { icon: redIcon })
  .addTo(mapa_cabeza)
  .bindPopup(
    "<strong>sko</strong><p>[sko]</p>" +
      '<audio controls><source src="audios/cabeza/OT11-20-03-01-H2-CWO-K-597_cabeza.wav"></source></audio>'
  );
...
var inde = L.marker([18.2398340950581, -96.6453256830706], { icon: blueIcon })
  ...
  .bindPopup(
    "<strong>sku</strong><p>[sku]</p>" +
      '<audio controls><source src="audios/cabeza/OT11-20-11-01-M1-ARV-K-597.wav"></source></audio>'
  );
var ayau = L.marker([18.0316244671714, -96.6691758468062], { icon: blueIcon })
  .addTo(mapa_cabeza)
  .bindPopup(
    "<strong>nindaku</strong><p>[ni<sup>n</sup>daku]</p>" +
      '<audio controls><source src="audios/cabeza/cabeza.ERN.ayautla.wav"></source></audio>'
  );
...
var jal = L.marker([18.07063037252, -96.5335047459864], { icon: blueIcon })
  ...
  .bindPopup(
    "<strong>nintaku̱</strong><p>[ni<sup>2n</sup>ta<sup>2</sup>ku<sup>1</sup>]</p>" +
      '<audio controls><source src="audios/cabeza/cabeza RSS Jalapa.wav"></source></audio>'
  );
...
var soya = L.marker([18.239934772662025, -96.41377809451589], {
  ...
  .bindPopup(
    "<strong>tku̱</strong><p>[tku<sup>1</sup>]</p>" +
      '<audio controls><source src="audios/cabeza/cabeza.wav"></source></audio>'
  );
...
var layerControl = L.control.layers(baseMaps, overlayMaps).addTo(mapa_cabeza);
